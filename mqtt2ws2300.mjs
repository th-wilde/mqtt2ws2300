...
mqtt.on("connect",function(){	
	...
	mqtt.publish("homeassistant/sensor/"+mqttConf.mqtt.prefix+"WindSpeed/config", '{"name": "Wind Speed", "state_topic": "'+mqttConf.mqtt.prefix+'WindSpeed", "unit_of_measurement": "km/h", "unique_id": "'+mqttConf.mqtt.prefix+'WindSpeed" }', retainOption);
