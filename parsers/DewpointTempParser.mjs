 ...
 */
class DewpointTempPaser extends WS2300Parser {
    constructor(mqttPublish) {
        super({ address: 0x3CE, length: 2 })
    ...
    process(data) {
        ...
        if (calcTemp < 80) {
            this.mqttPublish("DewpointTemp", calcTemp.toFixed(2));
        }
    }
}

export default DewpointTempPaser