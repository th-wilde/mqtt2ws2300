 ...
 */
class WindchillTempPaser extends WS2300Parser {
    constructor(mqttPublish) {
        super({ address: 0x3A0, length: 2 })
    ...
    process(data) {
        ...
        if (calcTemp < 80) {
            this.mqttPublish("WindchillTemp", calcTemp.toFixed(2));
        }
    }
}

export default WindchillTempPaser