 ...
 */
class OutdoorTempPaser extends WS2300Parser {
    constructor(mqttPublish) {
        super({ address: 0x373, length: 2 })
    ...
    process(data) {
        ...
        if (calcTemp < 80) {
            this.lastTemp = calcTemp;
            this.mqttPublish("OutdoorTemp", calcTemp.toFixed(2));
        }else{
            this.lastTemp = NaN;
        }
    }
...
export default OutdoorTempPaser